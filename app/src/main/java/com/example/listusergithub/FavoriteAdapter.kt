...
class FavoriteAdapter (private val favoriteUserList: List<FavoriteUser>) : RecyclerView.Adapter<FavoriteAdapter.ListUserViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ListUserViewHolder, position: Int) {
        val username = favoriteUserList[position].username
        val avatarURL = favoriteUserList[position].avatarUrl
